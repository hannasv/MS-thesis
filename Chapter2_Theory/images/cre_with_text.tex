\begin{figure}[ht]
    ...
    \begin{tikzpicture} %[remember picture,overlay]
        ...
        %\node at (13cm,9.75cm) {solar absorberbed surface};

        %\node at (2cm,9.75cm) {thermal outgoing TOA};
       
    \end{tikzpicture}
    \caption{Inspired by Figure 15 in \cite{Wild2019TheModels}. \textbf{Trude:} I wrote latent heat, wild have writtent evaporation. Aren't we inerrested in the heat flux assisiated with evaporation which is latent heat? Det er lett å bytte tilbake hva blir mest riktig..?}
    \label{fig:cre}
\end{figure}