\begin{figure*}
        ...
        \begin{subfigure}[b]{0.475\textwidth}   
            ...
            \caption{{\small MIR 3.9}}    
            \label{fig:MIR_3.9}
        \end{subfigure}
        \caption{{Spectral bands from SEVIRI. February 15, 2020 at noon. It shows the lowpressure system \textit{Elsa} positioned of the west coast of Iceland. Having a record breaking low of 915hPa (\cite{nrk_lavtrykk}). 
        The images are provided by the EUMETSATs image archive (\cite{eumetcast_image_gallery}).}
    } 
