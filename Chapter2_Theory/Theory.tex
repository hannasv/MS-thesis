...
Using reanalysis data for the environmental variable is a clear choice, there is no other products providing distributed data, coherent in time and space. 

Satelite data is the only platform (?) providing (almost) simultaneous global measurements, necessary for this task. 
Having demonstrated its usefulness for task of \textbf{Les i \cite{Stockli2019CloudApplications}}.
Secondly, the usefulness of rapid scans was given height priority when making the choices for the databasis of \acrshort{ecc}. This has been demonstrated for nowcasting and other application \textbf{add citations from \cite{Stockli2019CloudApplications}}.
