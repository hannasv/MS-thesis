...
\begin{equation} \label{eq:binary_param_clouds}
    CLA\left(RH\right) = 
     ...
     \end{cases}
\end{equation}
Sub-grid scale variability in humidity is necessary to achieve fractional cloud cover. This can be combined with other sub-grid scale variables, like temperature. Based on observations researches have attempted to find the distributions of these variables. In order to include them in models. 
