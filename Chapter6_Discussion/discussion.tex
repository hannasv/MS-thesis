...
The field dates back to the fifties. Pioneers was debating if it was possible to \textit{automatise task normally performed by humans}. Now a days machine learning is on everyone's tongue. Three factors determining the advances of the field; data, hardware and algorithmns. Algorithmns predating computers are still useful to this day. One example of this is logistic regression, which is used for binary classification problems. 
