...
\newacronym{era5}{ERA5}{ECMWF Reanalysis 5\textsuperscript{th} Generation}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% MET 
...
\newacronym{batchnorm}{Batch Norm}{Batch Normalization}
\newacronym{nwp}{NWP}{Numerical Weather Prediction}
\newacronym{hrv}{HRV}{High-Resolution Visible Channel}
%%%%%%%%%%%%%%%%%%% FILE-FORMATS
