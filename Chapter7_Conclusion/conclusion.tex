...
To improve upon the \acrshort{ar}-models ability to predict sequences it would be interresting to train different \acrshort{ar}-model for each timestep in a sequence. 
