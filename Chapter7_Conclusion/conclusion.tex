...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% CONCLUSION
In this study a high quality dataset, \acrfull{ecc} was compiled for the purpose of performing data-driven learning on cloud fractional cover. This involves the development of \acrfull{awrs} and derivation of relevant equations. Without this dataset proposed methods are useless. The databasis, both dataset and variables, have been carefully chosen and the produced product has $0.25^o$ spatial and hourly resolution. It consist of temperature, pressure, relative and specific humidity from \acrshort{er5} and cloud fractional cover, computed by \acrshort{awrs}, based on cloud masks from \acrshort{msg}.
...
Contribution by building a end-to-end trainable \acrshort{convlstm}-model. As far as the author knows, this study has trained a \acrshort{convlstm}-model on a larger dataset than done before. 
