...
% Start connecting all.
    ...
    \caption{Unrolling Figure \ref{fig:rnn} in time, $t$ denotes the length of the training sequence, the elements $x_t$ are the  Inspired by \citepaper{colah_blog_post}. % Used code from lstm unit to develop this one.
    }
