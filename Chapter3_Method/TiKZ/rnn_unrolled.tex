...
% Start connecting all.
    ...
    \caption{Unrolling Figure \ref{fig:rnn} in time, $t$ denotes the length of the training sequence, the elements $x_t$ are the input, $y_t$ the output and $h_t$ is the hidden states, rpresenting the memory. Inspired by \citepaper{colah_blog_post}. % Used code from lstm unit to develop this one.
    }
