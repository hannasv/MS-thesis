\begin{figure}[h] % h means place here if possible
    ...
    \caption{Decoding a image into \acrfull{rgb} channels involves transforming a 2-dimensional image into a 3-dimensional tensor. Inspired by Figure 1 in \citepaper{precip_nowcasting}.}
    \label{fig:2D_image}
\end{figure}