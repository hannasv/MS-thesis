\begin{figure}[h] % h means place here if possible
    ...
    \caption{Decoding a image into RGB (red green blue) channels involves transforming a 2-dimsional image into a 3-dimensional tensor. Inspired by Figure 1 in \cite{precip_nowcasting}.}
    \label{fig:2D_image}
\end{figure}