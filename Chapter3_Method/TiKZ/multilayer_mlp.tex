...
\caption{Deep fully connected neural network. An extension of the network presented in Figure \ref{fig:one_layer_mlp}. The sketch is based on the same example by \citepaper{ffnn}.}
