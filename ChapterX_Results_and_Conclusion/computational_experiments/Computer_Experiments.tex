...
The $TR$-configuration performs a lot better than $T$, and the set of models have an MAE close to $0.14$. Since $AR$ outperforms $TR$ for all configurations, except for $T$, this indicates that the environmental variables provide useful information. %\textbf{det har du allerede sakt} TS: Det er ok med litt gjentagelse :)
