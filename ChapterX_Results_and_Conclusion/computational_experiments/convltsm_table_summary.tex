...
\begin{table}[]
    ...
    \caption{Results, metrics and number of parameters for the trained models. The best model \acrshort{convlstm}-model is highlighted in light blue. \textbf{Update to best-model.} X denotes models finished running, others are in progress. }
