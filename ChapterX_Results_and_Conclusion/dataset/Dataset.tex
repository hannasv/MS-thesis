...
This section presents the developed algorithms necessary for the compilation of the dataset \acrfull{ecc}. It is pieced together from two sources, ERA5 reanalysis and \acrfull{msg} cloud mask. The common period of 2004 to 2018 is selected. The downloaded size of \acrshort{ecc} is 17Gb, stored in \acrshort{netcdf}-files.
...
There are multiple global reanalysis datasets available. ERA5 was chosen since its the latest within reanalysis products and it has the highest resolution. %above JRA and MERRA because of the spatial resolution and because it the latest within reanalis products available. 
