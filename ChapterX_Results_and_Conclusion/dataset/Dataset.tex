...
There are multiple global reanalysis datasets available. \acrshort{era5} was chosen since its the latest within reanalysis products and it has the highest resolution. %above JRA and MERRA because of the spatial resolution and because it the latest within reanalis products available. 
