...
\begin{figure}
    ...
    \caption{Timeseries for the spike detected in Figure \ref{fig:first_week_sep_2012}. It does not look like a unphyscal hendelsesforløp}
...
Figure \ref{fig:all_stats_tcc}. Similar figures for the remaining variables in the dataset are presented in Section \ref{sec:all_stats}. %in the Appendix \ref{ch:appendix_statistic}. 
...
\begin{figure}
    ...
    \caption{\acrshort{mae} between the \acrshort{cfc} in ERA5 and \acrshort{ecc}. Revealing systematic errors in regions over the \textbf{add regions with systematic errors}, Summing over all pixels results in a MAE of $1.16508643\cdot10^8$. These systematic errors appear to be in region fewer observation, i.e. mountainous regions and over the sea. Dust storm causing the red ocean off the coast of Sahara..?}
