...
\begin{tikzpicture}[scale=5,tdplot_main_coords]
    ...
    \caption{Sketch to illustrated the relative size of neighbouring pixels in uniform grid of \acrshort{ecc}, projected onto spherical coordinates. The areas of pixels in a uniform grid decrease poleward.}
